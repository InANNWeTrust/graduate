...
const questions = [
  { 
    q: 'Какой тип задач вам интереснее всего решать?', 
    options: [
      'Математические уравнения и модели',
  ...
  { 
    q: 'Какой подход к решению проблем вам ближе?', 
    options: [
      'Аналитический и расчетный',
      'Экспериментальный и практический',
      'Технологический и инновационный',
      'Исследовательский и научный',
      'Командный и кооперативный'
    ] 
  },
  { 
    q: 'Какая область науки вас больше всего привлекает?', 
    options: [
      'Математика и физика',
      'Химия и материалы',
  ...
  { 
    q: 'Что для вас важнее всего в работе?', 
    options: [
  ...
  { 
    q: 'Где вы видите себя в будущем?', 
    options: [

...
const questions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      { text: 'Придумываю, как упростить что-то с помощью технологий', score: score(4, 1, 0) },
      { text: 'Разбираюсь, как устроена штука', score: score(0, 4, 1) },
      { text: 'Проверяю гипотезу на практике', score: score(0, 1, 4) },
    ],
  },
  {
    q: 'Какой вайб проекта тебе ближе?',
    options: [
      { text: 'Цифровой, умный и про данные', score: score(4, 1, 0) },
      { text: 'Инженерный, точный и логичный', score: score(1, 4, 1) },
      { text: 'Лабораторный, живой и экспериментальный', score: score(0, 1, 4) },
    ],
  },
  {
    q: 'Мем, который про тебя:',
    options: [
      { text: 'Ещё один тест, и всё станет ясно', score: score(4, 0, 0) },
  ...
  },
  {
    ...
    options: [
      { text: 'Место, где данные дают решения', score: score(4, 1, 0) },
      { text: 'Стенд с механизмом или прибором', score: score(0, 4, 1) },
      { text: 'Лаборатория с опытами', score: score(0, 1, 4) },
    ],
  },
  {
    q: 'Если делать мини-стартап, то что в основе?',
    options: [
      { text: 'Сервис, который анализирует и помогает', score: score(4, 0, 1) },
      { text: 'Устройство, которое можно собрать', score: score(1, 4, 0) },
      { text: 'Новый материал или состав', score: score(0, 1, 4) },
    ],
  },
  {
    q: 'Что тебе интереснее: найти закономерность, собрать систему или получить новый результат?',
    options: [
      { text: 'Найти закономерность и применить её', score: score(4, 0, 0) },
      { text: 'Собрать систему, где всё на месте', score: score(1, 4, 1) },
      { text: 'Получить новый и точный результат', score: score(0, 1, 4) },
    ],
  },
  {
    q: 'Какой "рабочий стол" кажется самым уютным?',
    options: [
      { text: 'Ноутбук, идеи и вкладки с анализом', score: score(4, 1, 0) },
      { text: 'Чертежи, инструменты и техника', score: score(0, 4, 1) },
      { text: 'Лабораторный стол, весы и баночки', score: score(0, 1, 4) },
    ],
  },
  {
    q: 'Какой результат радует сильнее всего?',
    options: [
      { text: 'Когда из хаоса получается точный вывод', score: score(4, 0, 1) },
      { text: 'Когда схема работает как задумано', score: score(0, 4, 1) },
      { text: 'Когда опыт даёт чёткий эффект', score: score(0, 1, 4) },
    ],
  },
  {
    q: 'Куда пойдешь завтра, если выбирать по интересу?',
    options: [
      { text: 'Туда, где технологии будущего и данные', score: score(4, 0, 1) },
      { text: 'Туда, где приборы и реальные установки', score: score(0, 4, 1) },
      { text: 'Туда, где исследуют и получают новое', score: score(0, 1, 4) },
    ],
  },
];

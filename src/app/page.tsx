...
const questions = [
  { 
    ...
    options: [
      'Физика и всё, что связано с энергией и частицами', // Ядерные физика и технологии
      'Химия и тайны превращения веществ', // Химическая технология
      'Информатика и программирование', // Информационные системы и технологии
      'Биология, анатомия и живые системы', // Биотехнические системы и технологии
      'Инженерное дело, черчение или технологии' // Инноватика
    ] 
  },
  { 
    q: 'Какие задачи тебе решать интереснее всего?', 
    options: [
      'Исследовать, моделировать, анализировать', // Прикладные математика и физика
      'Разрабатывать новые материалы и процессы', // Химическая технология материалов современной энергетики
      'Писать код, настраивать алгоритмы', // Информационные системы и технологии
      'Работать с данными, управлять системами', // Управление качеством
      'Изучать живые объекты и проектировать под них технологии' // Биотехнические системы и технологии
    ] 
  },
  { 
    q: 'Какой объект тебя больше привлекает?', 
    options: [
      'Ядерный реактор и защита от радиации', // Ядерные реакторы и материалы
      'Установка с датчиками и автоматикой', // Электроника и автоматика физических установок
      'Биосенсор, измеряющий параметры организма', // Биотехнические системы и технологии
      'Микроскоп и мир наноструктур', // Наноинженерия
      'Химический реактор с управляющим контролем' // Химическая технология
    ] 
  },
  { 
    q: 'Где бы тебе хотелось проводить больше времени?', 
    options: [
      'В лаборатории с пробирками и реагентами', // Химическая технология
      'За паяльником, схемами и осциллографом', // Электроника и наноэлектроника
      'В интерфейсе цифровой модели технологического процесса', // Информационные системы и технологии
      'В медицинском центре рядом с умной диагностикой', // Биотехнические системы и технологии
      'На объекте, где важна безопасность и точность' // Инженерия неразрушающего контроля
    ] 
  },
  { 
    q: 'Что ты считаешь самым перспективным направлением?', 
    options: [
      'Атомная энергетика', // Ядерные физика и технологии
      'Цифровая инженерия', // Информационные системы и технологии
      'Технологии здоровья и медицины', // Биотехнические системы и технологии
      'Новые материалы и нанотехнологии', // Наноинженерия
      'Контроль, надёжность и стандарты качества' // Управление качеством
    ] 
  },
  { 
    q: 'Какой подход тебе ближе всего?', 
    options: [
      'Сделать один раз — и чтобы работало десятилетия', // Ядерные реакторы и материалы
      'Экспериментировать, чтобы найти лучшее', // Химическая технология материалов современной энергетики
      'Автоматизировать всё, что можно', // Электроника и автоматика физических установок
      'Проектировать с учётом потребностей человека', // Инноватика
      'Управлять рисками и минимизировать ошибки' // Инженерия неразрушающего контроля
    ] 
  },
  { 
    q: 'Какой образ больше отзывается?', 
    options: [
      'Серьёзный физик у установки', // Ядерные физика и технологии
      'Химик, смешивающий реактивы', // Химическая технология
      'Инженер, собирающий электронную систему', // Электроника и наноэлектроника
      'Исследователь, создающий цифровую платформу', // Информационные системы и технологии
      'Биотехнолог с планшетом у пациента' // Биотехнические системы и технологии
    ] 
  },
  { 
    q: 'Где тебе было бы комфортно работать?', 
    options: [
      'На ядерном объекте или в НИИ', // Ядерные реакторы и материалы
      'В цифровом стартапе или IT-компании', // Инноватика
      'В медицинском центре или лаборатории', // Биотехнические системы и технологии
      'На производстве с высокой автоматизацией', // Электроника и автоматика физических установок
      'В инновационном проектном офисе' // Инженерия неразрушающего контроля
    ] 
  },
  { 
    q: 'Кем ты себя видишь в будущем?', 
    options: [
      'Инженером по управлению установкой', // Ядерные реакторы и материалы
      'Разработчиком новых технологий', // Инноватика
      'Диагностом/биоинженером', // Биотехнические системы и технологии
      'Разработчиком интерфейсов и цифровых решений', // Информационные системы и технологии
      'Специалистом по контролю качества' // Управление качеством
    ] 
  },
  { 
    q: 'Какой принцип тебе ближе всего?', 
    options: [
      'Мощность и безопасность', // Ядерные физика и технологии
      'Гибкость и эффективность', // Управление качеством
      'Инновации и человекоориентированность', // Инноватика
      'Точность и надёжность', // Инженерия неразрушающего контроля
      'Развитие и масштабируемость' // Химическая технология материалов современной энергетики
    ] 
  }
];

...
// Инноватика
{ keyword: 'патент', direction: 'Инноватика' },
{ keyword: 'стартап', direction: 'Инноватика' },
{ keyword: 'инновации', direction: 'Инноватика' },

// Управление качеством
{ keyword: 'бережливое производство', direction: 'Управление качеством' },
{ keyword: 'стандарты', direction: 'Управление качеством' },
{ keyword: 'качество', direction: 'Управление качеством' },

// Прикладные математика и физика
{ keyword: 'квантовые вычисления', direction: 'Прикладные математика и физика' },
{ keyword: 'программирование', direction: 'Прикладные математика и физика' },
];
